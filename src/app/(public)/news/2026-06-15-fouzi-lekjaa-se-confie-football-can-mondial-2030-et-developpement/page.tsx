...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `Fouzi Lekjaa se confie : football, CAN, Mondial 2030 et développement`,
    description: `Dans un long entretien accordé au podcast Maghreb, enregistré au Complexe Mohammed VI de football à Rabat à la veille du départ de la sélection pour les Ét`,
    type: "article",
    publishedTime: "2026-06-15T11:07:46.000Z",
  },
}

const ARTICLE = {
  title: `Fouzi Lekjaa se confie : football, CAN, Mondial 2030 et développement`,
  summary: `Dans un long entretien accordé au podcast Maghreb, enregistré au Complexe Mohammed VI de football à Rabat à la veille du départ de la sélection pour les États-Unis, le président de la FRMF a abordé sans détour les grands dossiers du football marocain.   Le Complexe Mohammed VI, « centre névralgique » du football national C’est depuis...`,
  source: `TelQuel`,
  sourceUrl: `https://telquel.ma/instant-t/2026/06/15/fouzi-lekjaa-se-confie-football-can-mondial-2030-et-developpement_1994232/`,
  publishedAt: "2026-06-15T11:07:46.000Z",
  dateFr: "15 juin 2026",
}
...
const jsonLd = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://siyahamag.ma/news/2026-06-15-fouzi-lekjaa-se-confie-football-can-mondial-2030-et-developpement",
  },
}
