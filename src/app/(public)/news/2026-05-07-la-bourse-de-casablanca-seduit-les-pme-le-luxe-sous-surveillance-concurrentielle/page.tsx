...
export const metadata: Metadata = {
  title: `La Bourse de Casablanca séduit les PME, le luxe sous surveillance concurrentielle, Tanger Med agrège 40 multinationales : les 3 infos business à retenir | SiyahaMag`,
  ...
  alternates: { canonical: "/news/2026-05-07-la-bourse-de-casablanca-seduit-les-pme-le-luxe-sous-surveillance-concurrentielle" },
  openGraph: {
    title: `La Bourse de Casablanca séduit les PME, le luxe sous surveillance concurrentielle, Tanger Med agrège 40 multinationales : les 3 infos business à retenir`,
    description: `Ce qui se tente → La Bourse de Casablanca veut séduire les PME La Bourse de Casablanca et Maroc PME ont signé une convention-cadre pour rapprocher les TPME`,
    type: "article",
...
const jsonLd = {
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://siyahamag.ma/news/2026-05-07-la-bourse-de-casablanca-seduit-les-pme-le-luxe-sous-surveillance-concurrentielle",
  },
}
