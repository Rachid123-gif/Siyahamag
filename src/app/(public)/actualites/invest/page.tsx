...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Actualités Investissement Touristique Maroc | SiyahaMag",
    description:
      "Investissements hôteliers, projets de resorts et financements d'infrastructures touristiques au Maroc.",
    type: "website",
  },
...
export default function InvestPage() {
  const articles = getArticlesByCategory("INVEST")
      ...
      <div className="flex items-center gap-3 mb-8 mt-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Actualités de l&apos;investissement touristique au Maroc
          </p>
        </div>
      </div>
