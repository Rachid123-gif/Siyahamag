...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const guidePages: MetadataRoute.Sitemap = [
    ...
    {
      url: `${baseUrl}/guide/emploi-tourisme-casablanca-2026`,
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
    {
      url: `${baseUrl}/guide/reglementation-tourisme-maroc-2026`,
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
    {
      url: `${baseUrl}/guide/emploi-tourisme-marrakech-2026`,
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
    {
      url: `${baseUrl}/guide/investissement-maison-hotes-chefchaouen-2026`,
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
    {
      url: `${baseUrl}/guide/emploi-tourisme-tanger-2026`,
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
    {
      url: `${baseUrl}/guide/investissement-touristique-agadir-2026`,
      lastModified: now,
      changeFrequency: "monthly" as const,
      priority: 0.8,
    },
